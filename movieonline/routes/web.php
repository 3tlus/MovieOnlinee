...
Route::match (['get', 'post'], '/', [IndexController::class, 'home'])->name('homepage');
...
Route::match (['get', 'post'], '/add-rating', [IndexController::class, 'add_rating'])->name('add-rating');
Auth::routes();
...
Route::match (['get', 'post'], '/filter-topview-default', [MovieController::class, 'filter_default']);
