...
<head>
    ...
    <style>
        #header .site-title {
            background: url(https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/PNFilm_logo.svg/800px-PNFilm_logo.svg.png) no-repeat top left;
                                ...
                                <div class="input-group col-xs-12">
                                    <form action="{{ route('search') }}" method="GET">
                                        ...
                                        <button class="btn btn-primary"
                                            style="    float: right;
                                        margin-top: -31px;
                                        margin-right: -72px;">search</button>
                                    </form>
                                </div>
                ...
                <div class="widget about col-xs-12 col-sm-4 col-md-4">
                    <div class="footer-logo">
                        <img class="img-responsive"
                            src="https://banner2.cleanpng.com/20180515/hqq/kisspng-video-cameras-drawing-movie-camera-5afa6d78384649.5823023515263614642305.jpg"
                            alt="Phim hay 2021- Xem phim hay nhất" />
                    </div>
                    Group 4: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                        data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">Group4@gmail.com</a>
                </div>
            </div>
        </div>
        <div>
            <p style="float: right;
            margin-top: -147px;
            margin-right: 366px;">Xem phim online
                miễn phí chất lượng cao với phụ đề tiếng việt - thuyết minh - lồng tiếng. <br> Phim có nhiều thể
                loại
                phim phong phú, đặc sắc, nhiều bộ phim hay nhất - mới nhất.
            </p>
            <p style="float: right;
            margin-top: -80px;
            margin-right: 120px;">
                Website <i class="fas fa-phoenix-framework    "></i> với giao diện trực quan, thuận tiện, tốc độ tải
                nhanh, thường xuyên cập nhật các bộ
                phim mới hứa hẹn sẽ đem lại những trải nghiệm tốt cho người dùng
            </p>
        </div>
    </footer>
    <div id='easy-top'></div>
                    ...
                    $.getJSON('/json_file/movies.json', function(data) {
                        $.each(data, function(key, value) {
                            if (value.title.search(expression) != -1 || value.description
                                .search(expression) != -1) {
                                $('#result').append(
                                    '<li class="list-group-item link-class" style="cursor:pointer"><img height="40" width="40"  src="/uploads/movie/' +
