...
<head>
    ...
    <meta name="keywords" content=" WEB MOVIE" />
    ...
    <!-- //font-awesome icons CSS-->
    <!-- side nav css file -->
    <link href="{{ asset('backend/css/SidebarNav.min.cs') }}s" media="all" rel="stylesheet" type="text/css" />
    <!-- //side nav css file -->
    <!-- js-->
                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li class="treeview {{ $segment == 'movie' ? 'active' : '' }}">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('movie.index') }}"><i class="fa fa-angle-right"></i> Liệt
                                                kê movie</a>
                                        </li>
                                    </ul>
                                </li>
