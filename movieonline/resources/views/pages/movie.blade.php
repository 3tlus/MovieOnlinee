                                ...
                                @if ($movie->resolution != 5)
                                    @if ($episode_current_list_count > 0)
                                        <div class="bwa-content">
                                            ...
                                            <a href="{{ url('xem-phim/' . $movie->slug . '/tap-' . $episode_tapdau->episodede) }}"
                                                class="bwac-btn">
                                    ...
                                    @endif
                                @else
                                    <a href="#watch_trailer" style="display: block" class="btn btn-primary">Traler</a>
                                @endif
                                        ...
                                        @if ($episode_current_list_count > 0)
                                            @if ($movie->belongingmo == 'phimbo')
                                                @foreach ($episode as $key => $ep)
                                                    <a href="{{ url('xem-phim/' . $ep->movie->slug . '/tap-' . $ep->episodede) }}"
                                                        rel="tag">Tập
                                                        {{ $ep->episodede }}</a>
                                                @endforeach
                                            @elseif($movie->belongingmo == 'phimle')
                                                @foreach ($episode as $key => $ep_le)
                                                    <a href="{{ url('xem-phim/' . $movie->slug . '/tap-' . $ep_le->episodede) }}"
                                                        rel="tag">{{ $ep_le->episodede }}</a>
                                                @endforeach
                                            @endif
                                        @else
                                            đang cập nhật
